...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Amu Pictures captures Ethiopia's most beautiful moments — Habesha weddings, graduations, cultural events, engagements, and family stories told cinematically." },
      { property: "og:title", content: "Amu Pictures — Ethiopian Cinematic Photography" },
      { property: "og:description", content: "Habesha weddings, graduations, and cultural stories filmed cinematically in Addis Ababa." },
    ],
